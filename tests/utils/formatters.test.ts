...
describe('Formatters Utils', () => {
  ...
  describe('formatCurrency (Argentinian pesos)', () => {
    it('debe formatear precios enteros sin decimales', () => {
      expect(formatCurrency(100)).toBe('$100');
      expect(formatCurrency(1000)).toBe('$1.000');
    });

    it('debe formatear precios con decimales cuando son necesarios', () => {
  ...
  describe('formatPriceARS', () => {
    ...
    it('debe formatear con decimales cuando se especifica', () => {
      ...
      expect(formatPriceARS(100.50, true)).toBe('$100,50');
    });
  });
