...
describe("URL Parameter Sanitization", () => {
  ...
  describe("Redirect URL Validation", () => {
    ...
    it("should allow relative URLs", () => {
      ...
      expect(isValidRedirectUrl("/admin/dashboard", ["example.com"])).toBe(
        true
      );
    });
    ...
    it("should allow whitelisted domains", () => {
      expect(
        isValidRedirectUrl("https://example.com/page", ["example.com"])
      ).toBe(true);
    });

    it("should reject non-whitelisted domains", () => {
      expect(
        isValidRedirectUrl("https://evil.com/phish", ["example.com"])
      ).toBe(false);
    });

    it("should reject protocol-relative URLs", () => {
      expect(isValidRedirectUrl("//evil.com/phish", ["example.com"])).toBe(
        false
      );
    });
  });
