 ...
 * 
 * SOLO DISPONIBLE EN DESARROLLO O PARA ADMINS
 */
export async function GET(request: NextRequest): Promise<NextResponse> {
    try {
        ...
        const diagnostics = {
            ...
            resendKeyPrefix: resendApiKey ? resendApiKey.substring(0, 10) + "..." : "(no configurada)",
            adminEmail,
            targetEmail: toEmail,
        ...
        return fail(
            "INTERNAL_ERROR",
            error instanceof Error ? error.message : "Error al enviar email de prueba",
            500
        );
    }
}
