...
import { Search, Home, Package, ArrowLeft, TrendingUp } from "lucide-react";
          ...
          <div className="mb-8">
            ...
            <div className="relative -mt-16 md:-mt-20">
              ...
              <p className="text-lg muted max-w-2xl mx-auto">
                ...
                tenemos muchas otras cosas geniales para mostrarte.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="surface border border-muted hover:shadow-md transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <h4 className="font-semibold text-primary mb-2">Página Principal</h4>
