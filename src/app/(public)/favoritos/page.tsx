...
export const metadata: Metadata = {
  ...
  description: 'Gestiona tu lista de productos favoritos. Guarda los productos que más te gusten para comprarlos más tarde.',
...
const FavoritosPageSkeleton = () => (
  <div className="container mx-auto px-4 py-8">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
      {[...Array(8)].map((_, i) => (
        <div key={`favorites-skeleton-${i}`} className="surface rounded-lg border border-muted overflow-hidden">
