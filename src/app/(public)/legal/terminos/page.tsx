      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-sm sm:prose lg:prose-lg max-w-none space-y-6 text-content-secondary">
          ...
          <section>
            ...
            <p className="mb-4">
              Este sitio web está destinado exclusivamente para uso personal y no
              comercial. No puedes:
            </p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Nos reservamos el derecho de cancelar pedidos en caso de falta de
                stock o problemas con el pago
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                El cargo se realizará al momento de confirmar el pedido
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Retiro en tienda:</strong> sin costo, disponible en 24-48
                horas
              </li>
              <li>
          ...
          <section>
            ...
            <p className="mb-4">
              ...
              momento. Los cambios entrarán en vigencia al ser publicados en esta
              página. Te recomendamos revisar periódicamente estos términos.
            </p>
