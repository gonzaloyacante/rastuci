        ...
        <div className="prose prose-sm sm:prose lg:prose-lg max-w-none space-y-6 text-content-secondary">
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Datos de envío:</strong> dirección, ciudad, código postal
              </li>
              <li>
              ...
              <li>
                <strong>Datos de navegación:</strong> cookies, dirección IP, tipo
                de navegador
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>MercadoPago:</strong> para procesar pagos de forma segura
              </li>
              <li>
