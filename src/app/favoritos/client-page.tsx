...
import { Heart, ShoppingCart, Trash2, Filter, Grid3X3, List } from 'lucide-react';
            ...
            viewMode === 'grid' ? (
              ...
              >
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="relative w-full md:w-48 aspect-square md:aspect-square flex-shrink-0">
                    <Image
                      src={item.image}
                      alt={item.name}
                      fill
