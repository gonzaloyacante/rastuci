  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-primary">Sucursales Correo Argentino</h1>
          <p className="text-muted mt-1">
            Gestiona y sincroniza las sucursales de Correo Argentino con la base de datos
          </p>
        </div>
      </div>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <Button
                  onClick={() => selectedProvince && loadAgencies(selectedProvince)}
          ...
          <CardContent className="py-12 text-center text-muted">
            {selectedProvince ? (
              <>
                ...
                <p className="text-lg font-medium mb-2">No se encontraron sucursales</p>
                <p className="text-sm">
                  {searchTerm
              ...
              <>
                ...
                <p className="text-lg font-medium mb-2">Selecciona una provincia</p>
                <p className="text-sm">Elige una provincia para cargar sus sucursales</p>
              </>
            )}
          </CardContent>
        </Card>
              ...
              <CardContent className="space-y-2">
                ...
                {agency.phone && (
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <a href={`tel:${agency.phone}`} className="text-primary hover:underline text-xs">
                      {agency.phone}
                    </a>
                  </div>
                )}
