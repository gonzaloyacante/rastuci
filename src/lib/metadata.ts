...
export function generateStoreJsonLd() {
  ...
  return {
    ...
    "@id": baseUrl,
    url: baseUrl,
    telephone: process.env.NEXT_PUBLIC_CONTACT_PHONE || "+5491100000000",
    address: {
      "@type": "PostalAddress",
      streetAddress: process.env.NEXT_PUBLIC_STORE_ADDRESS || "Calle Falsa 123",
      addressLocality: process.env.NEXT_PUBLIC_STORE_CITY || "Buenos Aires",
      postalCode: process.env.NEXT_PUBLIC_STORE_ZIP || "1000",
      addressCountry: process.env.NEXT_PUBLIC_STORE_COUNTRY || "AR",
    },
    geo: {
      "@type": "GeoCoordinates",
      latitude: Number(process.env.NEXT_PUBLIC_STORE_LAT) || -34.6037,
      longitude: Number(process.env.NEXT_PUBLIC_STORE_LNG) || -58.3816,
    },
