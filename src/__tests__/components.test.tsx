...
describe('Button Component', () => {
  ...
  it('renders with different variants', () => {
    ...
    expect(screen.getByRole('button')).toHaveClass('surface', 'border', 'border-primary');

    rerender(<Button variant="destructive">Destructive Button</Button>);
    expect(screen.getByRole('button')).toHaveClass('surface', 'border', 'border-error');
  });
...
describe('Badge Component', () => {
  ...
  it('renders with different variants', () => {
    ...
    expect(screen.getByText('Success Badge')).toHaveClass('bg-success/10', 'text-success');

    rerender(<Badge variant="error">Error Badge</Badge>);
    expect(screen.getByText('Error Badge')).toHaveClass('bg-error/10', 'text-error');

    rerender(<Badge variant="warning">Warning Badge</Badge>);
    expect(screen.getByText('Warning Badge')).toHaveClass('bg-warning/10', 'text-warning');
  });
