      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center mb-2 space-x-1">
            {[...Array(5)].map((_, i) => (
              <Skeleton key={`star-skeleton-${i}`} className="h-6 w-6" />
            ))}
          </div>
        ...
        <div className="space-y-2">
          {[...Array(5)].map((_, i) => (
            <div key={`rating-bar-${i}`} className="flex items-center gap-3">
    ...
    <div className="surface rounded-lg p-6 border border-muted">
      ...
      <div className="space-y-4">
        <div className="flex space-x-2">
          {[...Array(5)].map((_, i) => (
            <Skeleton key={`form-star-${i}`} className="h-8 w-8" />
          ))}
        </div>
    ...
    <div className="space-y-4">
      {[...Array(3)].map((_, i) => (
        <div
          ...
          className="surface rounded-lg p-6 border border-muted"
        >
          <div className="flex items-start justify-between mb-3">
            ...
            <div className="flex space-x-1">
              {[...Array(5)].map((_, j) => (
                <Skeleton key={`review-star-${j}`} className="h-4 w-4" />
              ))}
            </div>
          </div>
