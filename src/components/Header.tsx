        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            >
              ...
              {getWishlistCount() > 0 && (
                <span
                  className="absolute -top-1 -right-1 surface text-primary border border-primary text-xs rounded-full w-5 h-5 flex items-center justify-center"
                  aria-hidden="true"
                >
                  {getWishlistCount()}
                </span>
            ...
            {searchTerm.length > 0 && (
              <div className="space-y-2">
                ...
                <div className="space-y-1">
                  {["Ropa de bebé", "Ropa de niña", "Accesorios", "Pijamas"]
                    .filter((suggestion) =>
                      suggestion
                        .toLowerCase()
            ...
            {searchTerm.length === 0 && (
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  {["Ropa de bebé", "Pijamas", "Accesorios", "Ofertas"].map(
                    (popular, index) => (
                      <button
                        key={`item-${index}`}
                        onClick={() => {
