    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="surface-secondary rounded-lg p-4 space-y-4">
        <h3 className="font-semibold text-lg">
          Dirección de Origen (Logística)
        </h3>
        <p className="text-sm muted">
          Esta dirección se utiliza EXCLUSIVAMENTE para calcular el costo de
          envío con Correo Argentino y como remitente en las etiquetas.
        </p>
          ...
          <label className="flex items-center gap-3 cursor-pointer">
            ...
            <div>
              ...
              <div className="text-sm text-muted">
                Se mostrará "ENVÍO GRATIS" en el checkout. El costo lo absorbe
                la tienda.
              </div>
            </div>
          </label>
