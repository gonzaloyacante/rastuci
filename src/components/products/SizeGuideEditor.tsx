        ...
        <div className="space-y-4 overflow-x-auto">
            <div className="min-w-[600px] border rounded-lg overflow-hidden bg-surface">
                ...
                <div className="divide-y">
                    {sizes.map((size) => (
                        <div key={size} className="flex items-center hover:bg-surface-secondary/20">
                            <div className="w-32 shrink-0 p-3 font-bold text-sm text-primary flex items-center gap-2">
                                <span className="w-6 h-6 rounded bg-neutral-100 dark:bg-neutral-800 flex items-center justify-center text-xs">
                                    {size}
                                </span>
                            </div>
                            {columns.map((_, colIdx) => {
                                ...
                                return (
                                    ...
                                    >
                                        <Input
                                            value={val}
                                            onChange={(e) => updateMeasurement(size, colIdx, e.target.value)}
                                            placeholder="-"
            ...
            <p className="text-xs text-muted-foreground flex items-center gap-2">
                ...
                Tip: Puedes renombrar las columnas (ej: "Largo Manga", "Cintura") escribiendo sobre ellas.
            </p>
        </div>
    );
}
