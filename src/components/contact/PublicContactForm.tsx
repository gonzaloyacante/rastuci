...
export const PublicContactForm = ({ contact }: { contact: ContactSettings }) => {
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-3 gap-3">
                                    <button
                                        ...
                                        className={`flex flex-col items-center gap-2 p-4 rounded-xl border-2 transition-all duration-200 ${formData.responsePreference === "EMAIL"
                                    ...
                                    <button
                                        ...
                                        className={`flex flex-col items-center gap-2 p-4 rounded-xl border-2 transition-all duration-200 ${formData.responsePreference === "PHONE"
                                                ? "border-primary bg-primary/10 text-primary"
                                                : "border-theme surface hover:border-primary/50"
                                            }`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`flex flex-col items-center gap-2 p-4 rounded-xl border-2 transition-all duration-200 ${formData.responsePreference === "WHATSAPP"
                                                ? "border-primary bg-primary/10 text-primary"
                                                : "border-theme surface hover:border-primary/50"
                                            }`}
                                    >
